                                ...
                                <div id="myTabContent" class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                        <div class="product-tab">
                                            @foreach($categoryProducts as $categoyProduct)
                                            <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                <div class="grid-arr">
                                                    <div  class="grid-arrival">
                                                        <figure>
                                                            <a href="{{ url('/product-details/'.$categoyProduct->id) }}" class="new-gri">
                                                                <div class="grid-img">
                                                                    <img  src="{{ asset($categoyProduct->product_image) }}" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="grid-img">
                                                                    <img  src="{{ asset($categoyProduct->product_image) }}" class="img-responsive"  alt="">
                                                                </div>
                                                    ...
                                                    <div class="women">
                                                        <h6><a href="single.html">{{ $categoyProduct->product_name }}</a></h6>
                                                        <span class="size">XL / XXL / S </span>
                                                        <p ><em class="item_price">Tk. {{ $categoyProduct->product_price }}</em></p>
                                                        <a href="{{ url('/direct-add-to-cart/'.$categoyProduct->id) }}" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach
                                        ...
                                        <div class="product-tab1">
                                            ...
                                            <div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
                                                ...
                                                <div class="women">
                                                    <h6><a href="single.html">{{ $categoyProduct->product_name }}</a></h6>
                                                    <span class="size">XL / XXL / S </span>
                                                    <p>{{ $categoyProduct->short_description }}</p>
                                                    <p ><em class="item_price">Tk. {{ $categoyProduct->product_price }}</em></p>
                                                    <a href="{{ url('/direct-add-to-cart/'.$categoyProduct->id) }}" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                                                </div>
                                            </div>
