        ...
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                <div class="well">
                    ...
                    <form  action="{{ url('/new-brand') }}" method="POST" id="myform" class="form-horizontal">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label for="brand_name" class="col-sm-3">Brand Name</label>
                            <div class="col-sm-9">
                                <input class="form-control" type="text" name="brand_name" id="brand_name" placeholder="Type Brand name" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="brand_description" class="col-sm-3">Brand Description</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" rows="10" name="brand_description" id="brand_description" placeholder="Type Brand description" style="resize: vertical;" required></textarea>
                            </div>
                        </div>
                        <div class="form-group">
